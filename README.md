...
Please cite the following paper if you use MOSAIK in your research: [Baptista et al., (2026). MOSAIK: Multi-Origin Spatial Transcriptomics Analysis and Integration Kit. Journal of Open Source Software, 11(117), 8795, https://doi.org/10.21105/joss.08795]([https://arxiv.org/abs/2505.11384](https://joss.theoj.org/papers/10.21105/joss.08795))
...
⚠️ We recommend creating a conda environment based on the YAML file (`napari.yml`) located in the `env` folder. This environment will install **Napari 0.4.17** and all required dependencies during its creation.  To create the corresponding conda environment, run the following command in a terminal:
  ...
  ```bash
   ...
   ```
2. Launch Napari from the terminal by typing napari, using the previously created conda environment.
